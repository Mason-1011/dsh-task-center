...
export type TaskOperation = 'create' | 'edit' | 'claim' | 'progress' | 'block' | 'submit' | 'approve' | 'reject' | 'abandon' | 'wake-set' | 'wake-clear';
...
export type TaskErrorCode = 'TASK_NOT_FOUND' | 'TASK_STALE_REVISION' | 'TASK_ALREADY_CLAIMED' | 'TASK_NOT_CLAIMED' | 'TASK_FORBIDDEN' | 'TASK_INVALID_OBJECTIVE' | 'TASK_INVALID_ACCEPTANCE' | 'TASK_INVALID_NOTE' | 'TASK_INVALID_REASON' | 'TASK_INVALID_TRANSITION' | 'TASK_WAKE_INVALID_RULE' | 'TASK_INVALID_FILTER';
